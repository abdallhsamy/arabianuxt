...
<template>
  <section class="space-y-8">
          ...
          <thead class="text-gray-400">
            <tr class="text-start">
              ...
              <th class="py-2 text-end">
                {{ t("pages.team.tableHeaders.actions") }}
              </th>
            </tr>
          </thead>
          <tbody class="divide-y divide-white/10">
            ...
            >
              ...
              <td class="py-3 text-end">
                <button
                  class="px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/15 text-rose-300 flex items-center gap-1"
    ...
    <UiModal
      v-model="inviteOpen"
      :title="t('pages.team.inviteNewMember')"
      :confirm-text="t('pages.team.sendInvite')"
      @confirm="invite"
    >
      <div class="space-y-3">
        <input
          ...
          :placeholder="t('pages.team.fullName')"
        />
        <input
          v-model="inviteEmail"
          class="input-dark w-full"
          :placeholder="t('pages.team.emailAddress')"
        />
