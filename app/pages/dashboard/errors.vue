...
const errors = ref<Err[]>([
  {
    id: "E-2025-01",
    time: "2025-10-08 11:22",
    message: "Unhandled promise rejection in payments.js",
    severity: "critical",
    trace:
  ...
  {
    id: "E-2025-02",
    time: "2025-10-08 09:10",
    message: "Cache miss threshold exceeded",
    severity: "warning",
    trace: "Warning: Cache utilization > 85% at RedisCluster node-2",
  },
  {
    id: "E-2025-03",
    time: "2025-10-07 22:01",
