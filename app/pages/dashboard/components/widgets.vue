...
<template>
  <section class="p-8 space-y-10 text-gray-100">
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <UiAnalyticsCard :label="t('pages.componentWidgets.analytics.revenue')" value="$45K" change="+8%" icon="💰" color="emerald" :progress="80" />
      <UiAnalyticsCard :label="t('pages.componentWidgets.analytics.activeUsers')" value="1.2K" change="+4%" icon="👥" color="cyan" :progress="70" />
      <UiAnalyticsCard :label="t('pages.componentWidgets.analytics.bounceRate')" value="24%" change="-3%" icon="📉" color="amber" :progress="40" />
      <UiAnalyticsCard :label="t('pages.componentWidgets.analytics.errors')" value="12" change="+2%" icon="⚠️" color="rose" :progress="20" />
    </div>
