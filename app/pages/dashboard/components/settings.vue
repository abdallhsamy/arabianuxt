...
const notices = ref<Notice[]>([
  { id: 'n1', title: t('pages.componentSettings.notifications.buildComplete'), body: t('pages.componentSettings.notifications.deploymentFinished'), time: t('pages.componentSettings.notifications.twoMinAgo') },
  { id: 'n2', title: t('pages.componentSettings.notifications.newSignup'), body: t('pages.componentSettings.notifications.userJoined'), time: t('pages.componentSettings.notifications.tenMinAgo'), read: true },
])
...
<template>
  <section class="p-8 space-y-6 text-gray-100">
    ...
    <p class="text-sm text-gray-400">{{ t('pages.componentSettings.currentTheme') }}: <span class="text-gray-200">{{ themeValue }}</span></p>
  </section>
