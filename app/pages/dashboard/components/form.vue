...
<template>
  <section class="space-y-8 p-8">
    ...
    <UiFormField :label="t('pages.componentForm.labels.name')">
      <UiInput
        v-model="form.name"
        :label="t('pages.componentForm.labels.name')"
        :placeholder="t('pages.componentForm.placeholders.enterName')"
      />
    </UiFormField>
    ...
    <UiFormField :label="t('pages.componentForm.labels.bio')">
      <UiTextarea
        v-model="form.bio"
        :label="t('pages.componentForm.labels.bio')"
        :placeholder="t('pages.componentForm.placeholders.writeBio')"
      />
    </UiFormField>
    ...
    <UiFormField>
      <UiCheckbox
        v-model="form.agree"
        :label="t('pages.componentForm.labels.agreeToTerms')"
      />
    </UiFormField>
    ...
    <UiFormField :label="t('pages.componentForm.labels.selectPlan')">
      <div class="flex gap-4 flex-wrap">
        <UiRadio
          v-model="form.plan"
          value="free"
          :label="t('pages.componentForm.plans.free')"
          name="plan"
        />
        <UiRadio
          v-model="form.plan"
          value="pro"
          :label="t('pages.componentForm.plans.pro')"
          name="plan"
        />
        <UiRadio
          v-model="form.plan"
          value="enterprise"
          :label="t('pages.componentForm.plans.enterprise')"
          name="plan"
        />
      </div>
    </UiFormField>
    ...
    <UiFormField :label="t('pages.componentForm.labels.featureToggle')">
      <UiSwitch
        ...
        :label="t('pages.componentForm.labels.enableFeature')"
      />
    </UiFormField>
    ...
    <UiFormField :label="t('pages.componentForm.labels.date')">
      <UiDatePicker
        v-model="form.date"
        :placeholder="t('pages.componentForm.placeholders.pickDate')"
      />
    </UiFormField>
    ...
    <!-- Debug Preview -->
    <pre
      class="bg-gray-900 text-gray-300 p-4 rounded-xl border border-white/10 overflow-x-auto text-sm"
