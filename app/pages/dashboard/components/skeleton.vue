  ...
  <section class="p-8 space-y-10 text-gray-100">
    ...
    <div>
      <h2 class="font-semibold mb-2">
        {{ t("pages.componentSkeleton.variants.shimmer") }}
      </h2>
      <UiSkeleton
        variant="rect"
        width="100%"
    ...
    <div>
      <h2 class="font-semibold mb-2">
        {{ t("pages.componentSkeleton.variants.pulse") }}
      </h2>
    ...
    <div>
      <h2 class="font-semibold mb-2">
        {{ t("pages.componentSkeleton.variants.static") }}
      </h2>
      <UiSkeleton
        variant="rect"
        width="100%"
    ...
    <div>
      <h2 class="font-semibold mb-2">
        {{ t("pages.componentSkeleton.sections.intensitySpeed") }}
      </h2>
    ...
    <UiSkeletonGroup :loading="loading">
      ...
      <div class="space-y-3">
        <h2 class="text-xl font-semibold">
          {{ t("pages.componentSkeleton.loadedData.title") }}
        </h2>
