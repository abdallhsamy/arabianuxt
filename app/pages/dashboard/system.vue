    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="p-[2px] rounded-2xl bg-[conic-gradient(from_var(--angle),#8B5CF6_0%,#22D3EE_60%,#EC4899_100%)] animate-rotate-gradient">
        <div class="rounded-2xl bg-[rgba(15,17,23,0.92)] backdrop-blur-xl border border-white/10 p-6">
          <h2 class="text-white font-semibold text-lg mb-4 flex items-center gap-2"><Settings class="w-5 h-5 text-cyan-400" /> Environment</h2>
          <input v-model="envName" class="input-dark w-full" placeholder="Environment name" />
        </div>
      </div>
      ...
      <div class="p-[2px] rounded-2xl bg-[conic-gradient(from_var(--angle),#22D3EE_0%,#8B5CF6_60%,#EC4899_100%)] animate-rotate-gradient">
        <div class="rounded-2xl bg-[rgba(15,17,23,0.92)] backdrop-blur-xl border border-white/10 p-6">
          <h2 class="text-white font-semibold text-lg mb-4 flex items-center gap-2"><Sun class="w-5 h-5 text-amber-300" /> Theme</h2>
          <div class="flex items-center gap-3">
            <button class="px-4 py-2 rounded-xl bg-white/10 hover:bg-white/15 text-white flex items-center gap-2" @click="theme = 'dark'"><Moon class="w-4 h-4" /> Dark</button>
            <button class="px-4 py-2 rounded-xl bg-white/10 hover:bg-white/15 text-white flex items-center gap-2" @click="theme = 'light'"><Sun class="w-4 h-4" /> Light</button>
            <span class="text-gray-400 text-sm">Selected: {{ theme }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="p-[2px] rounded-2xl bg-[conic-gradient(from_var(--angle),#EC4899_0%,#8B5CF6_50%,#22D3EE_100%)] animate-rotate-gradient">
        <div class="rounded-2xl bg-[rgba(15,17,23,0.92)] backdrop-blur-xl border border-white/10 p-6">
          <h2 class="text-white font-semibold text-lg mb-4 flex items-center gap-2"><Timer class="w-5 h-5 text-indigo-400" /> Session Timeout</h2>
          <div class="flex items-center gap-3">
      ...
      <div class="p-[2px] rounded-2xl bg-[conic-gradient(from_var(--angle),#22D3EE_0%,#EC4899_50%,#8B5CF6_100%)] animate-rotate-gradient">
        <div class="rounded-2xl bg-[rgba(15,17,23,0.92)] backdrop-blur-xl border border-white/10 p-6">
          <h2 class="text-white font-semibold text-lg mb-4 flex items-center gap-2"><Wrench class="w-5 h-5 text-rose-400" /> Maintenance Mode</h2>
