...
const services = ref<Service[]>([
  {
    name: t("pages.health.services.apiGateway"),
    status: "up",
    latency: "120 ms",
  },
  {
    name: t("pages.health.services.dbCluster"),
    status: "degraded",
    latency: "340 ms",
  },
  {
    name: t("pages.health.services.authServer"),
    status: "up",
    latency: "90 ms",
  },
  ...
  <section class="space-y-8">
    ...
    <GradientCard>
      <div class="flex flex-wrap justify-center gap-8">
        <MetricMini
          :label="t('pages.health.cpuUsage')"
          color="rgba(236,72,153,0.8)"
        />
        <MetricMini
          :label="t('pages.health.memoryUsage')"
          color="rgba(139,92,246,0.8)"
        />
        <MetricMini
          :label="t('pages.health.diskIo')"
          color="rgba(34,197,94,0.8)"
        />
        <MetricMini
          :label="t('pages.health.network')"
