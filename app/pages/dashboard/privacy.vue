...
import { ref } from "vue";
import { Eye, Trash2, Download, ShieldCheck, Lock } from "lucide-vue-next";
    ...
    >
      ...
      >
        ...
        >
          ...
          {{ t("pages.privacy.dataTrackingPreferences") }}
        </h2>
      ...
      >
        ...
        >
          ...
          >
            ...
            {{ t("pages.privacy.deleteAccountData") }}
          </h2>
          <p class="text-sm text-[var(--text-secondary)] mb-4">
    ...
    >
      ...
      >
        <h2
          class="flex items-center gap-2 text-white font-semibold text-lg mb-2"
        >
          <ShieldCheck class="w-5 h-5 text-fuchsia-400" />
          {{ t("pages.privacy.howWeProtectData") }}
        </h2>
        <p>
