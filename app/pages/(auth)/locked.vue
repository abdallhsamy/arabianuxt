...
<template>
  ...
  >
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,rgba(139,92,246,0.2),transparent_60%)] -z-10"></div>

    <div class="rounded-3xl p-[2px] bg-[conic-gradient(from_var(--angle),#22D3EE_0%,#EC4899_50%,#8B5CF6_100%)] animate-rotate-gradient">
      <div
