...
export const accordionSchema: PlaygroundSchema = {
    ...
    title: 'Accordion',
    props: [
        { key: 'items', type: 'string', default: '[{"id":"item1","title":"Section 1","content":"Content for section 1"},{"id":"item2","title":"Section 2","content":"Content for section 2"},{"id":"item3","title":"Section 3","content":"Content for section 3"}]' },
        { key: 'multiple', type: 'boolean', default: false },
        { key: 'orientation', type: 'enum', options: ['vertical', 'horizontal'], default: 'vertical' },
