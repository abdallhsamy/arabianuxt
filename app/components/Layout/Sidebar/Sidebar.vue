...
const { isExpanded, isMobile, checkViewport, toggleSidebar, setExpanded } =
  useSidebar();
...
const menuItems = [
  ...
  {
    icon: Sparkles,
    label: t("navigation.aiPlayground"),
    to: "/dashboard/ai-playground",
  },
  ...
  {
    icon: Zap,
    label: t("navigation.automationRules"),
  ...
  {
    icon: MessageSquare,
    label: t("navigation.toasterDemo"),
    to: "/dashboard/toaster-demo",
  },
  ...
  {
    icon: AlertCircle,
    label: t("navigation.alert"),
    to: "/dashboard/components/alert",
  },
  {
    icon: Badge,
    label: t("navigation.badge"),
    to: "/dashboard/components/badge",
  },
  {
    icon: CreditCardIcon,
    label: t("navigation.card"),
    to: "/dashboard/components/card",
  },
  {
    icon: BarChart,
  ...
  {
    icon: Code,
    label: t("navigation.devTools"),
    to: "/dashboard/components/dev-tools",
  },
  {
    icon: Table,
    label: t("navigation.table"),
    to: "/dashboard/components/table",
  },
  {
    icon: Type,
    label: t("navigation.input"),
    to: "/dashboard/components/input",
  },
  {
    icon: ToggleLeft,
    label: t("navigation.switch"),
    to: "/dashboard/components/switch",
  },
  {
    icon: FileTextIcon,
    label: t("navigation.textarea"),
    to: "/dashboard/components/textarea",
  },
  {
    icon: SquareIcon,
    label: t("navigation.skeleton"),
    to: "/dashboard/components/skeleton",
  },
  {
    icon: Target,
    label: t("navigation.stepper"),
    to: "/dashboard/components/stepper",
  },
  {
    icon: Wrench,
    label: t("navigation.utilities"),
    to: "/dashboard/components/utilities",
  },
  {
    icon: Grip,
    label: t("navigation.widgets"),
    to: "/dashboard/components/widgets",
  },
  {
    icon: Droplets,
    label: t("navigation.advancedUi"),
    to: "/dashboard/components/advanced-ui",
  },
  {
    icon: Cpu,
    label: t("navigation.aiTools"),
    to: "/dashboard/components/ai-tools",
  },
  {
    icon: Hash,
    label: t("navigation.accordion"),
    to: "/dashboard/components/accordion",
  },
  {
    icon: Image,
    label: t("navigation.dropdown"),
    to: "/dashboard/components/dropdown",
  },
  { icon: List, label: t("navigation.form"), to: "/dashboard/components/form" },
  {
    icon: Maximize2,
    label: t("navigation.modal"),
    to: "/dashboard/components/modal",
  },
  {
    icon: Minus,
    label: t("navigation.select"),
    to: "/dashboard/components/select",
  },
  { icon: Plus, label: t("navigation.tabs"), to: "/dashboard/components/tabs" },
  {
    icon: RotateCcw,
    label: t("navigation.tooltip"),
    to: "/dashboard/components/tooltip",
  },
  {
    icon: Search,
    label: t("navigation.interaction"),
    to: "/dashboard/components/interaction",
  },
  ...
  {
    icon: Palette,
    label: t("navigation.themeCustomizer"),
    to: "/dashboard/theme-customizer",
  },
...
<template>
  ...
  >
    <!-- Header -->
    <div
      class="flex items-center w-full p-3 border-b border-white/10 justify-between"
    >
      <span
    ...
    <!-- Nav -->
    <nav
      class="flex flex-col w-full mt-2 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent"
    >
      <template v-for="group in menuGroups" :key="group.label">
        ...
        >
          <div
            class="h-px bg-gradient-to-r from-transparent via-gray-600 to-transparent"
          ></div>
        </div>
    ...
    <div class="mt-auto mb-3 w-full px-3 flex justify-center z-10">
      ...
      >
        ...
        <template v-else>
          ...
          <span class="text-sm font-semibold text-white z-10 text-start">{{
            t("common.upgrade")
          }}</span>
        </template>
      </button>
