...
<template>
  <div
    class="p-[2px] rounded-2xl bg-[conic-gradient(from_var(--angle),#8B5CF6_0%,#EC4899_50%,#22D3EE_100%)] animate-rotate-gradient"
  >
    <div
        ...
        >
          ...
          <div class="sm:col-span-3">
            <span
              ...
              :class="chipClasses(row.severity)"
            >
              <span
          ...
          <div class="sm:col-span-2 text-right text-xs text-gray-400">
            {{ row.time }}
          </div>
        </li>
      </transition-group>
