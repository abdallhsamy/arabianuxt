    ...
    <div class="rounded-2xl bg-[rgba(15,17,23,0.94)] border border-white/10 p-4">
      <div class="flex items-start justify-between gap-3">
        ...
        <div class="shrink-0 flex gap-2">
          <button class="px-2 py-1 rounded-lg bg-white/10 hover:bg-white/15 text-white text-xs"
                  @click="$emit('use', id)">Use</button>
          <button class="px-2 py-1 rounded-lg bg-white/10 hover:bg-white/15 text-white text-xs"
                  @click="onCopy">Copy</button>
          <button class="px-2 py-1 rounded-lg bg-rose-500/15 hover:bg-rose-500/25 text-rose-300 text-xs border border-rose-400/20"
                  @click="$emit('delete', id)">Delete</button>
        </div>
      </div>
