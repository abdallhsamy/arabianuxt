...
<template>
  <div
    class="p-6 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xl space-y-4"
  >
    ...
    <div>
      ...
      <pre
        class="bg-black/40 text-gray-300 text-sm p-3 rounded-lg whitespace-pre-wrap"
      >
System: {{ system }}
User: {{ user }}
Tags: {{ tags.join(", ") }}
