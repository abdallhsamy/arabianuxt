  ...
  >
    <transition-group name="toast" tag="div">
      ...
      >
        <!-- Icon -->
        <component
            :is="t.type === 'success' ? CheckCircle2 :
        ...
        <div class="flex-1">
          ...
          <p v-if="t.message" class="text-sm text-gray-300 mt-1">{{ t.message }}</p>
        ...
        <div
            ...
            :class="{
            'bg-gradient-to-r from-emerald-400 to-cyan-400': t.type==='success',
