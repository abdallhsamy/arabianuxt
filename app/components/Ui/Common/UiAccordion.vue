...
<template>
  <div
      ...
      props.orientation === 'horizontal' ? 'flex divide-x divide-white/10' : 'flex flex-col divide-y divide-white/10',
    ]"
  >
    <div
    ...
    >
      ...
      <transition name="accordion">
        ...
        >
          <slot :name="item.id">
            <div v-html="typeof item.content === 'function' ? item.content() : item.content"></div>
          </slot>
        </div>
      </transition>
    </div>
