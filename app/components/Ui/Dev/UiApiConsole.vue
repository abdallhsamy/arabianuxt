...
<template>
  <div class="rounded-2xl bg-white/5 border border-white/10 p-4 space-y-3">
    ...
    <div class="flex gap-2">
      <select v-model="req.method" class="bg-black/50 border border-white/10 rounded-md text-sm px-2 py-1 text-gray-100">
      ...
      />
      <button class="bg-fuchsia-600 hover:bg-fuchsia-700 text-white px-4 py-1.5 rounded-md text-sm" @click="send">
        Send
      </button>
    </div>
    ...
    <div class="rounded-lg border border-white/10 bg-black/70 p-2 text-sm text-gray-200 min-h-[80px]">
