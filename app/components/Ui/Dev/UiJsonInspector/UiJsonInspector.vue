...
import { ref } from "vue";
import type { UiJsonInspectorProps } from "./UiJsonInspector.type";
import {
  UiJsonInspectorDefaultValues,
  UiJsonInspectorTypeGuards,
} from "./UiJsonInspector.type";

defineProps<UiJsonInspectorProps>();
const open = ref<boolean>(UiJsonInspectorDefaultValues.Open);

const { isObject, isArray } = UiJsonInspectorTypeGuards;
</script>
  ...
  <div class="font-mono text-xs text-gray-200">
    <div class="cursor-pointer select-none mb-1" @click="open = !open">
      <span class="text-fuchsia-300">
        {{ rootKey || UiJsonInspectorDefaultValues.RootKey }}
      </span>
