...
<template>
  <div class="grid grid-cols-2 gap-2 rounded-xl border border-white/10 overflow-hidden">
    <pre ref="leftRef" class="bg-black/60 p-3 text-gray-300 overflow-auto max-h-[480px]">{{ left }}</pre>
    <pre ref="rightRef" class="bg-black/60 p-3 text-gray-300 overflow-auto max-h-[480px]">{{ right }}</pre>
  </div>
</template>
