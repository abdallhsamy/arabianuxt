...
<template>
  <div
    class="rounded-2xl border border-white/10 bg-black/60 backdrop-blur-xl overflow-hidden"
  >
    <div class="px-4 py-2 border-b border-white/10 text-sm text-gray-300">
      Diff
    </div>
