...
const props = defineProps<{ label: string; color: string; min?: number; max?: number }>()
...
onMounted(() => {
  ...
  chart = new Chart(ctx, {
    ...
    data: {
      labels: [props.label],
      datasets: [{ data: [0, 100], backgroundColor: [props.color, 'rgba(255,255,255,0.1)'], borderWidth: 0 }],
    },
