...
const sizeMap: Record<Required<UiSelectProps>['size'], { h: string; font: string; caret: string }> = {
...
watch(() => isOpen.value, (open) => open && nextTick(() => dropdownRef.value?.focus()))
</script>
...
<template>
  <div class="flex flex-col gap-1.5 w-full relative">
    ...
    <div
        ...
        isFocused ? 'ring-2 ring-fuchsia-500/40 border-white/10' : 'border-white/10',
      ]"
        @click="toggleOpen"
    >
      <!-- Floating label -->
      ...
      >
        ...
        <ul class="divide-y divide-white/5">
          <li
              ...
              :class="[
              s.font,
              option.value === props.modelValue ? 'text-fuchsia-300' : 'text-gray-200',
            ]"
          >
