...
import { ref, computed, defineAsyncComponent, h, Suspense, onErrorCaptured, watch } from 'vue'
...
const componentMap: Record<string, any> = {
  'Ui/Common/UiAccordion.vue': () => import('~/components/Ui/Common/UiAccordion.vue'),
  ...
  'Ui/Nav/UiBreadcrumb.vue': () => import('~/components/Ui/Nav/UiBreadcrumb.vue'),
  ...
  'Ui/Charts/UiChartArea.vue': () => import('~/components/Ui/Charts/UiChartArea.vue'),
  'Ui/Charts/UiChartBar.vue': () => import('~/components/Ui/Charts/UiChartBar.vue'),
  'Ui/Charts/UiChartPie.vue': () => import('~/components/Ui/Charts/UiChartPie.vue'),
  'Ui/Form/UiCheckbox.vue': () => import('~/components/Ui/Form/UiCheckbox.vue'),
  'Ui/Feedback/UiConfirmDialog.vue': () => import('~/components/Ui/Feedback/UiConfirmDialog.vue'),
  'Ui/Form/UiDatePicker.vue': () => import('~/components/Ui/Form/UiDatePicker.vue'),
  'Ui/Display/UiDivider.vue': () => import('~/components/Ui/Display/UiDivider.vue'),
  'Ui/Common/UiDropdown.vue': () => import('~/components/Ui/Common/UiDropdown.vue'),
  'Ui/Display/UiEmptyState.vue': () => import('~/components/Ui/Display/UiEmptyState.vue'),
  'Ui/Form/UiFileUpload.vue': () => import('~/components/Ui/Form/UiFileUpload.vue'),
  'Ui/Form/UiInput.vue': () => import('~/components/Ui/Form/UiInput.vue'),
  'Ui/Display/UiLoaderSpinner.vue': () => import('~/components/Ui/Display/UiLoaderSpinner.vue'),
  'Ui/Common/UiModal.vue': () => import('~/components/Ui/Common/UiModal.vue'),
  'Ui/Nav/UiPagination.vue': () => import('~/components/Ui/Nav/UiPagination.vue'),
  'Ui/Data/UiProgressBar.vue': () => import('~/components/Ui/Data/UiProgressBar.vue'),
  'Ui/Form/UiRadio.vue': () => import('~/components/Ui/Form/UiRadio.vue'),
  'Ui/Core/UiRating.vue': () => import('~/components/Ui/Core/UiRating.vue'),
  'Ui/Editor/UiRichEditor.vue': () => import('~/components/Ui/Editor/UiRichEditor.vue'),
  'Ui/Form/UiSelect.vue': () => import('~/components/Ui/Form/UiSelect.vue'),
  'Ui/Feedback/UiSkeleton.vue': () => import('~/components/Ui/Feedback/UiSkeleton.vue'),
  ...
  'Ui/Layout/UiThemeSwitcher.vue': () => import('~/components/Ui/Layout/UiThemeSwitcher.vue'),
...
const Component = defineAsyncComponent({
  loader: componentMap[props.schema.component] || (() => Promise.resolve({ default: () => h('div', 'Component not found') })),
  errorComponent: () => h('div', { class: 'text-red-400' }, 'Failed to load component'),
  ...
  for (const [key, value] of Object.entries(sanitized)) {
    ...
    if (Array.isArray(value)) {
      ...
      try {
        ...
        if (key === 'labels' || key === 'values' || key === 'colors' || key === 'datasets' || key === 'rows' || key === 'columns' || key === 'events' || key === 'options' || key === 'items') {
          sanitized[key] = []
        } else {
          sanitized[key] = value
        }
...
const values = ref<Record<string, any>>(
    Object.fromEntries(props.schema.props.map(p => {
...
const codeSnippet = computed(() => {
  try {
    const entries = Object.entries(values.value)
        .filter(([_, val]) => val !== '' && val !== false && val !== null && val !== undefined)
        .map(([k, v]) => {
